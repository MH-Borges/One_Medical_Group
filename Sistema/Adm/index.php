...
<head>
    ...
    <title>Administrativo One Medical Group</title>
...
<body>
    <header>
        <ul class="menu">
            ...
            <li <?php if (@$_GET["pag"] == "") { echo 'class="hide"'; } ?>>
                <div class="dropdown">
                    <button type="button" id="dropdownMiniMenu" data-bs-toggle="dropdown"></button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMiniMenu">
                        ...
                        <li>
                            <a class="dropdown-item" href="index.php?pag=tratamentos">
                                <img src="../../assets/sistema/tratamentos.svg" onload="SVGInject(this)">
                                Tratamentos
                            </a>
                        </li>
                        <li>
    ...
    <main id="Main_Adm">
        ...
        <section id="home" <?php if (@$_GET["pag"] !== "" && @$_GET["pag"] !== null) { echo 'class="hide"'; } ?>>
            ...
            <a class="itens" href="index.php?pag=tratamentos">
                <img src="../../assets/sistema/tratamentos.svg" onload="SVGInject(this)">
                Tratamentos
            </a>
        ...
        <?php 
            ...
            else if (@$_GET["pag"] == "tratamentos") { include_once("Tratamentos/tratamentos.php"); }
        ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h5>Já vai embora?</h5>
                        <h6>Tem certeza que gostaria de sair da sua conta?</h6>
                    </div>
